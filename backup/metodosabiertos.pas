...
type
  ...
  TMetodoAbiertos = class
    public
      ...
      function Newton(X0,EX:real;MAXIT: Integer;funcion:string) : real;
      function Secante(X0,EX:real;MAXIT: Integer;funcion:string) : real;
...
function TMetodoAbiertos.Newton(X0,EX:real;MAXIT: Integer;funcion:string) : real;
var
  cont,i : Integer;
...
function TMetodoAbiertos.Secante(X0,EX:real;MAXIT: Integer;funcion :string) : real;
var
  cont,i : Integer;
